...
class BottomSheetFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        decksButton.setOnClickListener {
            if (decksRecyclerViewLayout.isVisible) {
                ...
                deckIcon.setImageResource(R.drawable.filter_sheet_list_closed_icon)
            } else {
                decksRecyclerViewLayout.visibility = View.VISIBLE
                deckIcon.setImageResource(R.drawable.filter_sheet_list_open_icon)
            }
        }
        ...
        tagsButton.setOnClickListener {
            if (tagsRecyclerViewLayout.isVisible) {
                ...
                tagIcon.setImageResource(R.drawable.filter_sheet_list_closed_icon)
            } else {
                tagsRecyclerViewLayout.visibility = View.VISIBLE
                tagIcon.setImageResource(R.drawable.filter_sheet_list_open_icon)
            }
        }
        ...
        flagsButton.setOnClickListener {
            if (flagsRecyclerViewLayout.isVisible) {
                ...
                flagIcon.setImageResource(R.drawable.filter_sheet_list_closed_icon)
            } else {
                flagsRecyclerViewLayout.visibility = View.VISIBLE
                flagIcon.setImageResource(R.drawable.filter_sheet_list_open_icon)
            }
        }
        ...
        noteTypesButton.setOnClickListener {
            if (noteTypesRecyclerViewLayout.isVisible) {
                ...
                noteTypeIcon.setImageResource(R.drawable.filter_sheet_list_closed_icon)
            } else {
                noteTypesRecyclerViewLayout.visibility = View.VISIBLE
                noteTypeIcon.setImageResource(R.drawable.filter_sheet_list_open_icon)
            }
        }
        ...
        cardStatesButton.setOnClickListener {
            if (cardStatesRecyclerViewLayout.isVisible) {
                ...
                cardStateIcon.setImageResource(R.drawable.filter_sheet_list_closed_icon)
            } else {
                cardStatesRecyclerViewLayout.visibility = View.VISIBLE
                cardStateIcon.setImageResource(R.drawable.filter_sheet_list_open_icon)
            }
        }
    }
    ...
    /**
     *  Create search query based on filters selected
     */
